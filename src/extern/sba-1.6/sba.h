 ...
 * projections (idx1.e. wght in the expert drivers) into the memory containing their
 * covariances (idx1.e. covx arg). Note that this overwrites covx, making changes
...
/* expert drivers */
//change the covariance into weights added by Danping Zou 
 int
sba_motstr_levmar_wx(const int n, const int ncon, const int m, const int mcon, char *vmask, double *p,
           const int cnp, const int pnp, double *x, double *weightx, const int mnp,
...
//added by Danping Zou
 int
sba_mot_levmar_wx(const int n, const int m, const int mcon, char *vmask, double *p, const int cnp,
           double *x, double *weightx, const int mnp,
           void (*func)(double *p, struct sba_crsm *idxij, int *rcidxs, int *rcsubs, double *hx, void *adata),
           void (*fjac)(double *p, struct sba_crsm *idxij, int *rcidxs, int *rcsubs, double *jac, void *adata),
           void *adata, const int itmax, const int verbose, const double opts[SBA_OPTSSZ], double info[SBA_INFOSZ]);
...
/* extern int sba_crsm_common_row(struct sba_crsm *sm, int idx2, int k); */
